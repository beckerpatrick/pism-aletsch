...
vx = (np.loadtxt('T1980/velsx.dat', skiprows=1)).reshape((My, Mx))
vy = (np.loadtxt('T1980/velsy.dat', skiprows=1)).reshape((My, Mx))
...
fig.savefig('vels_jouvet_1980.png', bbox_inches='tight', dpi=300)
